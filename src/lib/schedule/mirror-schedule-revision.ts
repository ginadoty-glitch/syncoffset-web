...
function mapRowsForMirror(
  ...
  return shootDays.map((d, idx) => {
    ...
    const v2Payload = JSON.stringify({
      ...
      companyMoveType: d.companyMoveType ?? null,
      companyMoveDestinationSource: d.companyMoveDestinationSource ?? null,
      companyMoveDestinationConfidence: d.companyMoveDestinationConfidence ?? null,
