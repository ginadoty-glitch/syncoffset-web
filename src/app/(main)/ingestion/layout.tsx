    ...
    <div className="flex min-h-[calc(100vh-var(--dashboard-header-height,3rem))] flex-col">
      <div className="flex shrink-0 items-center gap-3 border-b px-4 py-3 md:px-6">
        <div className="flex flex-col gap-0.5">
          <span className="font-medium text-sm tracking-tight">Document Upload</span>
          <span className="text-muted-foreground text-xs">Upload and track production documents</span>
        </div>
        ...
        <Button variant="outline" size="sm" asChild>
          <Link href="/dashboard/production-documents">Production Documents</Link>
        </Button>
      </div>
